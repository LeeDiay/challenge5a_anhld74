...
if (isset($_POST['submit'])){
    ...
    if ($file_extension !== 'txt') {
        ...
        $query = "INSERT INTO challenges(challenge_name, hint, uploader, file_name, file_path, answer, content) VALUES ('$name', '$hint', '$uploader', '$file_name', '$file_path', '$answer', '$file_content')";
