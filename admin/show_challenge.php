                                ...
                                <tbody>
                                    <?php foreach($challenges as $key => $challenge): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <a href="update_challenge.php?id=<?php echo $challenge['id']; ?>" class="btn btn-primary btn-sm">Update</a>
                                                <a href="show_challenge.php?delete=<?php echo $challenge['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Are you sure you want to delete this challenge?')">Delete</a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
