<?php
    ...
    if (isset($_POST['submit'])){
        ...
        $query = "INSERT INTO assignments(title, description, due_date, uploader, file_name, file_path) VALUES ('$title', '$description', '$due_date', '$uploader', '$file_name', '$file_path')";
        mysqli_query($conn, $query);
        $assignment_id = mysqli_insert_id($conn); // Get the ID of the inserted assignment
